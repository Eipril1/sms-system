    ...
    <el-aside :width="isCollapse ? '64px' : '220px'" class="aside">
      ...
      >
        ...
        <el-sub-menu index="database">
          ...
          <el-menu-item index="/database/hazard">
            <el-icon>
              <Warning/>
            </el-icon>
            <span>危险源库</span>
          </el-menu-item>
          <el-menu-item index="/database/hidden-danger">
            <el-icon>
              <CircleClose/>
            </el-icon>
            <span>隐患库</span>
          </el-menu-item>
          <el-menu-item index="/database/performance">
            <el-icon>
              <TrendCharts/>
            </el-icon>
            <span>绩效指标库</span>
          </el-menu-item>
          <el-menu-item index="/database/checklist">
            <el-icon>
              <Document/>
            </el-icon>
            <span>检查单库</span>
          </el-menu-item>
          <el-menu-item index="/database/self-inspection">
            <el-icon>
              <Search/>
            </el-icon>
            <span>法定自查库</span>
          </el-menu-item>
          <el-menu-item index="/database/findings">
            <el-icon>
              <Plus/>
            </el-icon>
            <span>发现项库</span>
